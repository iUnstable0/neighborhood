...
export default function ForParents() {
  ...
  return (
    ...
    <div className={`${mPlusRounded.variable} main`}>
      ...
      <li>Your child must have reached 100 hours of work on a singular project. This time is tracked with Hackatime and Stopwatch, features of the Neighborhood app. Stopwatch is intended for tasks that Hackatime cannot log (anything other than). Only 20 out of the 100 hours can be from Stopwatch, and there is no requirement that Stopwatch be used at all.)</li>
